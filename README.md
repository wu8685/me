...
ME 的知识全部保存在 Obsidian vault 中。通过 Obsidian Sync，可以让家里、
办公室或其他工作机器共享同一套 Raw、Practices、Cognition 与项目规则，
无论在哪台机器上与 Agent 协作，都能继续使用和积累同一份上下文。

云端同步由 Obsidian 提供，ME 不接管云存储，也不会把知识锁进自己的服务。
